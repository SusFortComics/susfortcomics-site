// Script to toggle mobile navigation
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // approach avoids having to upload binary assets separately, which is 
      // helpful
      ...
      if (homeImgs && homeImgs.length >= 3 && typeof TREEHOUSE1_DATA_URI !== 
 'undefined') {
      ...
      // Gallery page images
      // Disabled gallery injection since images are embedded directly in gallery.html
      /*
      var galleryImgs = document.querySelectorAll('.gallery img');
      if (galleryImgs && galleryImgs.length >= 3 && typeof GALLERY1_DATA_URI !==
  'undefined') {
